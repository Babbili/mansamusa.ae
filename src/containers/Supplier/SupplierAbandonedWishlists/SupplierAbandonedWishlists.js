...
import styles from './SupplierAbandonedWishlists.module.scss'


const SupplierAbandonedWishlists = ({ isTrial, approved, isSubscribed, currentStore }) => {
        ...
        state.isBanner ?
          <div className={`${styles.emptyData}`}>
            <div className='col-12 text-center'>
              ...
              <h3>
                { t('noAbandonedWishlistsYet.label') }
              </h3>
              <div className={styles.description}>
                { t('informationWillBeShownHere.label') }
              </div>
            </div>
          </div> :
          <div className={styles.SupplierAbandonedWishlists}>
...
export default SupplierAbandonedWishlists
