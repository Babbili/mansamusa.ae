...
import styles from './SupplierViewProductsFiltersSelector.module.scss'


const SupplierViewProductsFiltersSelector = ({ type, handleCancel, handleCustomData }) => {
...
export default SupplierViewProductsFiltersSelector
