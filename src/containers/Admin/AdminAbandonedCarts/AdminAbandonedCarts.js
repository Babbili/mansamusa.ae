...
import styles from './AdminAbandonedCarts.module.scss'


const AdminAbandonedCarts = props => {
    ...
    <>

      {
        state.isBanner ?
          ...
          <div className={styles.AdminAbandonedCarts}>
